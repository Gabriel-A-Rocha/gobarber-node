...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const numberOfDaysInMonth = (0, _dateFns.getDaysInMonth)(new Date(year, month - 1)); // creates an array starting at 1 and ending at the last day of the month (28, 29, 30 or 31)

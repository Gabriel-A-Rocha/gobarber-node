...
class AppointmentsRepository {
  ...
  async findAllInMonthFromProvider({
    ...
    // this method includes a 0 in single character months (e.g., 1 -> 01)
    const parsedMonth = String(month).padStart(2, '0'); // obs: month starts from 00 in the database (January -> 00, December -> 11)
  ...
  async findAllInDayFromProvider({
    ...
    // this method includes a 0 in single character days/months (e.g., 1 -> 01)
